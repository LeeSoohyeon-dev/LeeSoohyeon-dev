...
<a href="https://drive.google.com/file/d/1to2MuxL64z7cdZoqoVtvSXasWazCftFE/view?usp=drive_link" style="text-decoration: none;">
...
|-----------|------|----------|------------|---------|
| **FloodVR** | 침수 대비 VR 안전교육 게임 | Unity | 프로젝트 총괄 및 상호작용 시스템 개발 | 4인 |
| **Arcane Show** | 빙의 어드벤처 게임 | Unreal | 프로젝트 총괄 및 플레이어 기능, 게임 시스템 개발 | 3인 |
